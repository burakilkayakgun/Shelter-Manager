		...
		if ($conn->connect_error) {
			...
			if($result->num_rows > 0){
				...
				?>
					...
					?>
					<form action="delete_sponsor_response.php?id=<?php echo $temp["ID"]; ?>" method="post">
					...
					<p>Phone: <input type="text" name="Phone" value = "<?php echo $temp["Phone"] ?>" readonly /> </p>
					<p>Animal: <input type="text" name="Animal" value = "<?php echo $temp["Animal"] ?>" readonly /> </p>
